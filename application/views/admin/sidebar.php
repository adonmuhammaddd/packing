<aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?= $this->uri->segment(1) == 'kwh-prabayar' || $this->uri->segment(1) == 'kwh-static' || $this->uri->segment(1) == 'generateseri' ? 'active' : '' ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li <?= $this->uri->segment(1) == 'kwh-prabayar' ? 'class="active"' : '' ?>><a href="<?= base_url('kwh-prabayar');?>"><i class="fa fa-dashboard"></i> kWh Prabayar</a></li>
